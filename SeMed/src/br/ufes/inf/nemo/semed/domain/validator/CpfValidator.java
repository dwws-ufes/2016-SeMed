package br.ufes.inf.nemo.semed.domain.validator;
...
public class CpfValidator implements Validator {
	...
	public static String retiraCaracteres(String value)  {
        /*
     ...
     */
     private static boolean validaCPF(String value) {
    	 String cpf = retiraCaracteres(value);
